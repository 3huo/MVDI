function [pred_boxes, scores ,feat6, feat7] = fast_rcnn_conv_feat_detect(conf, caffe_net, im, conv_feat_blob, boxes, max_rois_num_in_gpu)
...
%         disp(['ssssss:',num2str(ceil(total_rois / max_rois_num_in_gpu))]);
    ...
    %% 加入各个层提取特征
    feat6 = caffe_net.blobs('fc6').get_data();
    feat7 = caffe_net.blobs('fc7').get_data();
    %%
