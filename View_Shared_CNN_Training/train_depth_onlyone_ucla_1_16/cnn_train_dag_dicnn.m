...
%     end      
    ...
    state.view_index = 2;
    stats_view2.train(epoch) = process_epoch(net_view1, state, opts, 'train') ;
    %---------------------view3----------------------
%     for layer = 1:10
...
%     end
    ...
    state.view_index = 3;
    stats_view3.train(epoch) = process_epoch(net_view1, state, opts, 'train') ;
    %---------------------view4----------------------
%     for layer = 1:10
...
%     end
    ...
    state.view_index = 4;
    stats_view4.train(epoch) = process_epoch(net_view1, state, opts, 'train') ;
    %---------------------view5----------------------
%     for layer = 1:10
...
%     end
    ...
    state.view_index = 5;
    stats_view5.train(epoch) = process_epoch(net_view1, state, opts, 'train') ;
    %------------------- over train-----------------
    % test ------
    %-----------------------------------------------
    state.view_index = 1 ;
    ...
    state.view_index = 2 ;
    state.imdb = imdb_view2 ;
    stats_view2.val(epoch) = process_epoch(net_view1, state, opts, 'val') ;
    %--------------------
    state.view_index = 3 ;
    state.imdb = imdb_view3 ;
    stats_view3.val(epoch) = process_epoch(net_view1, state, opts, 'val') ;
    %--------------------
    state.view_index = 4 ;
    state.imdb = imdb_view4 ;
    stats_view4.val(epoch) = process_epoch(net_view1, state, opts, 'val') ;
    %--------------------
    state.view_index = 5 ;
    state.imdb = imdb_view5 ;
    stats_view5.val(epoch) = process_epoch(net_view1, state, opts, 'val') ;
     %------------------- over test-----------------
  else
  ...
  if ~evaluateMode && (mod(epoch,20)==0)
    ...
    saveState(modelPath_view2(epoch), net_view1, stats_view2) ;
    saveState(modelPath_view3(epoch), net_view1, stats_view3) ;
    saveState(modelPath_view4(epoch), net_view1, stats_view4) ;
    saveState(modelPath_view5(epoch), net_view1, stats_view5) ;
  end
