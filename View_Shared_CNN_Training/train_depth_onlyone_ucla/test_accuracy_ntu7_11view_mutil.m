...
% net_view1 = dagnn.DagNN.loadobj(load('F:\chenjun\dynamic\exp\ucla_one_view1\net-deployed-view1.mat')) ;
% net_view1.mode = 'test' ;
% net_view2 = dagnn.DagNN.loadobj(load('F:\chenjun\dynamic\exp\ucla_one_view2\net-deployed-view2.mat')) ;
% net_view2.mode = 'test' ;
% net_view3 = dagnn.DagNN.loadobj(load('F:\chenjun\dynamic\exp\ucla_one_view3\net-deployed-view3.mat')) ;
% net_view3.mode = 'test' ;
% net_view4 = dagnn.DagNN.loadobj(load('F:\chenjun\dynamic\exp\ucla_one_view4\net-deployed-view4.mat')) ;
% net_view4.mode = 'test' ;
% net_view5 = dagnn.DagNN.loadobj(load('F:\chenjun\dynamic\exp\ucla_one_view5\net-deployed-view5.mat')) ;
% net_view5.mode = 'test' ;
...
for i = 1:length(index_train)
    ...
    temp1 = load([file,'\',pic_name(1:end-4),'.mat'],'data');
    temp1 = temp1.data;
    for view = 1:11
