...
opts.expDir_view1  = fullfile('exp', 'uwa12_one_view1') ;
opts.expDir_view2  = fullfile('exp', 'uwa12_one_view2') ;
opts.expDir_view3  = fullfile('exp', 'uwa12_one_view3') ;
opts.expDir_view4  = fullfile('exp', 'uwa12_one_view4') ;
opts.expDir_view5  = fullfile('exp', 'uwa12_one_view5') ;
...
if exist(imageStatsPath_view1)&& exist(imageStatsPath_view2)&&exist(imageStatsPath_view3)...
    ...
    [averageImage_view1,averageImage_view2,averageImage_view3,...
       averageImage_view4,averageImage_view5] = getImageStats(opts, net.meta, imdb_view1) ;
...
[net_view1,net_view2,net_view3,net_view4,net_view5,...
    stats_view1, stats_view2,stats_view3,stats_view4,stats_view5,param_all]...
    ...
    getBatchFn(opts, net_view1.meta),param_all,...
