...
function  [net_view1,net_view2,net_view3,net_view4,net_view5,...
    ...
    imdb_view1,imdb_view2,imdb_view3,imdb_view4,imdb_view5,getBatch,param_all,varargin)
                  
opts.expDir_view1  = fullfile('exp', 'uwa_share_view112_O') ;
opts.expDir_view2  = fullfile('exp', 'uwa_share_view212_O') ;
opts.expDir_view3  = fullfile('exp', 'uwa_share_view312_O') ;
opts.expDir_view4  = fullfile('exp', 'uwa_share_view412_O') ;
opts.expDir_view5  = fullfile('exp', 'uwa_share_view512_O') ;
...
%   state.imdb = imdb ;
  ...
  if numGpus <= 1
    ...
    opts.averageImage = param_all.net1.average;
    ...
    opts.averageImage = param_all.net2.average;
    ...
    opts.averageImage = param_all.net3.average;
    ...
    opts.averageImage = param_all.net4.average;
    ...
    opts.averageImage = param_all.net5.average;
  ...
  if ~evaluateMode && (mod(epoch,20)==0)
    for layer = 11:16
        net_view1.params(layer).value = param_all.net1.layer(layer).value;
    end
    net_view1.meta.normalization.averageImage = param_all.net1.average;
