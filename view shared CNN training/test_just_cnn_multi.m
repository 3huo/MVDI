...
net_view1.mode = 'test' ;
net_view2 = dagnn.DagNN.loadobj(load('F:\chenjun\dynamic\exp\uwa_multi_view212\net-deployed-view2.mat')) ;
net_view2.mode = 'test' ;
net_view3 = dagnn.DagNN.loadobj(load('F:\chenjun\dynamic\exp\uwa_multi_view312\net-deployed-view3.mat')) ;
net_view3.mode = 'test' ;
net_view4 = dagnn.DagNN.loadobj(load('F:\chenjun\dynamic\exp\uwa_multi_view412\net-deployed-view4.mat')) ;
net_view4.mode = 'test' ;
net_view5 = dagnn.DagNN.loadobj(load('F:\chenjun\dynamic\exp\uwa_multi_view512\net-deployed-view5.mat')) ;
net_view5.mode = 'test' ;

%all view is the same imdb
imdb = load('F:\chenjun\dynamic\exp\uwa_multi_view112\imdb.mat') ;
