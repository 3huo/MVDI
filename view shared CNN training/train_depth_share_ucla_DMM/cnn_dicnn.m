...
opts.dataDir = fullfile('data','UCLA_DMM') ;
opts.expDir_view1  = fullfile('exp', 'ucla_DMM_view1') ;
opts.expDir_view2  = fullfile('exp', 'ucla_DMM_view2') ;
opts.expDir_view3  = fullfile('exp', 'ucla_DMM_view3') ;
opts.expDir_view4  = fullfile('exp', 'ucla_DMM_view4') ;
opts.expDir_view5  = fullfile('exp', 'ucla_DMM_view5') ;
