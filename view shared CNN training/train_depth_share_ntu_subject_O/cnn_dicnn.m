...
opts.dataDir = fullfile('data','ntu_subject_O') ;
opts.expDir_view1  = fullfile('exp', 'ntu_sharesubject_O_view1') ;
opts.expDir_view2  = fullfile('exp', 'ntu_sharesubject_O_view2') ;
opts.expDir_view3  = fullfile('exp', 'ntu_sharesubject_O_view3') ;
opts.expDir_view4  = fullfile('exp', 'ntu_sharesubject_O_view4') ;
opts.expDir_view5  = fullfile('exp', 'ntu_sharesubject_O_view5') ;
