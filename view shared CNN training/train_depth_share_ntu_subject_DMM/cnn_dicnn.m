...
opts.dataDir = fullfile('data','ntu_subject_DMM_MBB') ;
opts.expDir_view1  = fullfile('exp', 'ntu_DMM_sharesubject_view1') ;
opts.expDir_view2  = fullfile('exp', 'ntu_DMM_sharesubject_view2') ;
opts.expDir_view3  = fullfile('exp', 'ntu_DMM_sharesubject_view3') ;
opts.expDir_view4  = fullfile('exp', 'ntu_DMM_sharesubject_view4') ;
opts.expDir_view5  = fullfile('exp', 'ntu_DMM_sharesubject_view5') ;
