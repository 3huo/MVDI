...
opts.expDir_view1  = fullfile('exp', 'ucla_share_view1_O') ;
opts.expDir_view2  = fullfile('exp', 'ucla_share_view2_O') ;
opts.expDir_view3  = fullfile('exp', 'ucla_share_view3_O') ;
opts.expDir_view4  = fullfile('exp', 'ucla_share_view4_O') ;
opts.expDir_view5  = fullfile('exp', 'ucla_share_view5_O') ;
