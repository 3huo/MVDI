...
opts.expDir_view1  = fullfile('exp', 'uwa_share_view112') ;
opts.expDir_view2  = fullfile('exp', 'uwa_share_view212') ;
opts.expDir_view3  = fullfile('exp', 'uwa_share_view312') ;
opts.expDir_view4  = fullfile('exp', 'uwa_share_view412') ;
opts.expDir_view5  = fullfile('exp', 'uwa_share_view512') ;
