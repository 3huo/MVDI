...
opts.dataDir = fullfile('data','ntu_view_DMM_MBB') ;
opts.expDir_view1  = fullfile('exp', 'ntu_DMM_shareview_view1') ;
opts.expDir_view2  = fullfile('exp', 'ntu_DMM_shareview_view2') ;
opts.expDir_view3  = fullfile('exp', 'ntu_DMM_shareview_view3') ;
opts.expDir_view4  = fullfile('exp', 'ntu_DMM_shareview_view4') ;
opts.expDir_view5  = fullfile('exp', 'ntu_DMM_shareview_view5') ;
