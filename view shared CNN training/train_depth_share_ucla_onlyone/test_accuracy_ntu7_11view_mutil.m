...
for i = 1:length(index_train)
    ...
    if ~exist(['feature_multi_ntu_shared300_viewtest\',pic_name(1:end-4),'.mat'],'file')  
%         data1 = [];
%         data2 = [];
%         data3 = [];
%         data4 = []; 
        ...
        for view = 1:11
            ...
            data2 = [];
            for j = 1:5
                im_ =  imread(fullfile('F:\chenjun\dynamic\data\ntu_all\train\',[pic_name(1:end-4),'_',num2str(view),'_',num2str(j),'.jpg']));
                im_ = single(im_);
                if view == 1 || view == 2
                    net_temp = net_view1;
        ...
        save(['feature_multi_ntu_shared300_viewtest\',pic_name(1:end-4),'.mat'],'data');
        save(['feature_multi_ntu_shared300_viewtest_softmax\',pic_name(1:end-4),'_softmax.mat'],'datapre');
        clear data datapre
    end
...
%         data4 = []; 
        for view = 1:11
            ...
            data2 = [];
            for j = 1:5
                im_ =  imread(fullfile('F:\chenjun\dynamic\data\ntu_all\test\',[pic_name(1:end-4),'_',num2str(view),'_',num2str(j),'.jpg']));
                im_ = single(im_);
                if view == 1 || view == 2
                    net_temp = net_view1;
                elseif view == 3 || view == 4 || view == 5
