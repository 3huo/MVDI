...
%----------------mutil
weight = single(zeros(size(weight_f,1),size(weight_f,2),11,size(weight_f,4)));
weight(:,:,1:3,:) = weight_f;
weight(:,:,4:6,:) = weight_f;
weight(:,:,7:9,:) = weight_f;
weight(:,:,10:11,:) = weight_f(:,:,1:2,:);
...
net.meta.normalization.imageSize = [net.meta.normalization.imageSize(1:2),11,net.meta.normalization.imageSize(end)];
